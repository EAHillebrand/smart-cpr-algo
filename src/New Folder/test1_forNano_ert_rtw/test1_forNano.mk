###########################################################################
## Makefile generated for component 'test1_forNano'. 
## 
## Makefile     : test1_forNano.mk
## Generated on : Tue Jan 31 16:07:33 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test1_forNano.elf
...
PRODUCT_NAME              = test1_forNano
MAKEFILE                  = test1_forNano.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/eahil/DOCUME~1/GitHub/SMART-~1/src/NEWFOL~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test1_forNano.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/test1_forNano_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_MBED_ROOT)/tools/CMSIS/$(MBED_CMSIS_VERSION)/CMSIS/Include -I$(ARDUINO_MBED_ROOT)/hardware/mbed/$(MBED_LIB_VERSION)/cores/arduino -I$(ARDUINO_MBED_ROOT)/hardware/mbed/$(MBED_LIB_VERSION)/variants/ARDUINO_NANO33BLE -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=200000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=test1_forNano -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp $(START_DIR)/test1_forNano_ert_rtw/test1_forNano.c $(START_DIR)/test1_forNano_ert_rtw/test1_forNano_data.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoARMM4mbedScheduler.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/MW_arduinoNano33BLE_multitasking.c

MAIN_SRC = $(START_DIR)/test1_forNano_ert_rtw/ert_main.c
...
OBJS = MW_arduino_digitalio.o test1_forNano.o test1_forNano_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMM4mbedScheduler.o MW_arduinoNano33BLE_multitasking.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(LIBS) $(MAIN_OBJ)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(subst /,\,$(subst /,\,$(OBJS))) $(subst /,\,$(subst /,\,$(MAIN_OBJ))) $(subst /,\,$(subst /,\,$(LIBS))) $(subst /,\,$(subst /,\,$(SYSTEM_LIBS))) $(subst /,\,$(subst /,\,$(TOOLCHAIN_LIBS)))
...
%.o : $(START_DIR)/test1_forNano_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/test1_forNano_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/test1_forNano_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")


%.o : $(START_DIR)/test1_forNano_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/test1_forNano_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
ert_main.o : $(START_DIR)/test1_forNano_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


test1_forNano.o : $(START_DIR)/test1_forNano_ert_rtw/test1_forNano.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


test1_forNano_data.o : $(START_DIR)/test1_forNano_ert_rtw/test1_forNano_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
...
arduinoARMM4mbedScheduler.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoARMM4mbedScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")


MW_arduinoNano33BLE_multitasking.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/MW_arduinoNano33BLE_multitasking.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
