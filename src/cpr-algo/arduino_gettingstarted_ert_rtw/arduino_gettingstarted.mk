###########################################################################
## Makefile generated for component 'arduino_gettingstarted'. 
## 
## Makefile     : arduino_gettingstarted.mk
## Generated on : Tue Mar 28 17:19:43 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_gettingstarted.elf
...
PRODUCT_NAME              = arduino_gettingstarted
MAKEFILE                  = arduino_gettingstarted.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_gettingstarted.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=arduino_gettingstarted -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o arduino_gettingstarted.o arduino_gettingstarted_data.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_gettingstarted.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/arduino_gettingstarted.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_gettingstarted_data.o : $(START_DIR)/arduino_gettingstarted_ert_rtw/arduino_gettingstarted_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
