...
## Generated on : Sun Mar 26 15:32:54 2023
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DINTERNAL_XCP_MEM_BLOCK_1_SIZE=192 -DINTERNAL_XCP_MEM_BLOCK_1_NUMBER=1 -DINTERNAL_XCP_MEM_BLOCK_2_SIZE=144 -DINTERNAL_XCP_MEM_BLOCK_2_NUMBER=6 -DINTERNAL_XCP_MEM_BLOCK_3_SIZE=160 -DINTERNAL_XCP_MEM_BLOCK_3_NUMBER=6 -DINTERNAL_XCP_MEM_RESERVED_POOLS_TOTAL_SIZE=66206 -DINTERNAL_XCP_MEM_RESERVED_POOLS_NUMBER=7 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1 -DXCP_MEM_BLOCK_1_SIZE=96 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=48 -DXCP_MEM_BLOCK_2_NUMBER=3 -DXCP_MEM_BLOCK_3_SIZE=160 -DXCP_MEM_BLOCK_3_NUMBER=3 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1531 -DXCP_MEM_RESERVED_POOLS_NUMBER=4 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=3 -DXCP_MIN_EVENT_NO_RESERVED_POOL=4
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o rtGetInf.o rtGetNaN.o rt_nonfinite.o top_level_algo.o top_level_algo_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o rtiostream_serial_daemon.o
