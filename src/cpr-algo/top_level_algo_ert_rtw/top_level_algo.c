...
void top_level_algo_step(void)
{
...

  {
    ...
    if (top_level_algo_M->Timing.TaskCounters.TID[2] == 0) {
       ...
       */
      top_level_algo_B.Mod1 = ((((top_level_algo_DW.TappedDelay_X[0] +
    ...
    top_level_algo_B.Mean1_AccVal = top_level_algo_B.TappedDelay_l[0];
    str = 1;
    ...
    for (i = 18; i >= 0; i--) {
      /* S-Function (sdspstatfcns): '<S7>/Mean1' */
      top_level_algo_B.Mean1_AccVal += top_level_algo_B.TappedDelay_l[str];
      str++;
     ...
     */
    top_level_algo_B.Mean_AccVal_j = top_level_algo_DW.TappedDelay_X_p[0];
    str = 1;
    for (i = 98; i >= 0; i--) {
      top_level_algo_B.Mean_AccVal_j += top_level_algo_DW.TappedDelay_X_p[str];
      str++;
    }
     ...
     */
    top_level_algo_B.Mean_AccVal_j = top_level_algo_B.Mean_AccVal_j / 100.0 *
    ...
    top_level_algo_B.Mean1_AccVal = ((((top_level_algo_P.Gain_Gain *
      ...
      top_level_algo_B.u_k) + top_level_algo_B.u_cx;
    ...
    rtb_IsPos = ((top_level_algo_B.Mean1_AccVal >=
                 ...
                 (top_level_algo_B.Mean_AccVal_j >=
     ...
     *  Logic: '<S9>/OR'
     */
    rtb_AND = ((!Delay1_DSTATE_m_tmp) || (!Delay7_DSTATE_tmp));
     ...
     *  Logic: '<S9>/OR'
     */
    rtb_NOT = (Delay1_DSTATE_m_tmp && rtb_AND);
    ...
    if (top_level_algo_M->Timing.TaskCounters.TID[2] == 0) {
       ...
       */
      top_level_algo_B.Mean_AccVal_j = rt_modd_snf(top_level_algo_B.Mod1,
        top_level_algo_P.Constant1_Value_g);

      /* SwitchCase: '<S12>/Switch Case' incorporates:
       *  MATLABSystem: '<S10>/Divide by Constant and Round'
       *  Sum: '<S10>/Subtract'
       */
      top_level_algo_B.Mean1_AccVal = floor((top_level_algo_B.Mod1 -
        top_level_algo_B.Mean_AccVal_j) * 0.01);
       ...
       */
      top_level_algo_B.Mod1 = rt_modd_snf(top_level_algo_B.Mean_AccVal_j,
       ...
       *  Sum: '<S10>/Subtract1'
       */
      top_level_algo_B.Mean1_AccVal = floor((top_level_algo_B.Mean_AccVal_j -
      ...
      if (top_level_algo_B.Mod1 < 0.0) {
        top_level_algo_B.Mean1_AccVal = ceil(top_level_algo_B.Mod1);
      } else {
        top_level_algo_B.Mean1_AccVal = floor(top_level_algo_B.Mod1);
      }
    ...
    top_level_algo_B.Mod1 = (top_level_algo_DW.clockTickCounter <
    ...
    /* Chart: '<S11>/DataLogic' */
    if (top_level_algo_DW.temporalCounter_i1_a < 31U) {
    ...
    if (top_level_algo_DW.is_active_c6_top_level_algo == 0U) {
      ...
      switch (top_level_algo_DW.is_c6_top_level_algo) {
       case top_level_algo_IN_CHECK:
        ...
        } else if (top_level_algo_DW.temporalCounter_i1_a >= 10U) {
       ...
       case top_level_algo_IN_MASK:
        if (top_level_algo_DW.temporalCounter_i1_a >= 10U) {
       ...
       case top_level_algo_IN_START_l:
        if (top_level_algo_DW.temporalCounter_i1_a >= 20U) {
          top_level_algo_DW.is_c6_top_level_algo = top_level_algo_IN_MASK;
          top_level_algo_DW.temporalCounter_i1_a = 0U;
          top_level_algo_B.data = top_level_algo_DW.Holder & 1U;
        }
       ...
       default:
        /* case IN_Wait: */
        if (top_level_algo_DW.temporalCounter_i1_a >= 5U) {
