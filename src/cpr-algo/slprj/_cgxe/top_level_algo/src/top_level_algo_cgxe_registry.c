...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 1433114769;
  checksumData[1] = 1530178702;
  checksumData[2] = 1055042332;
  checksumData[3] = 287638129;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 2156256374;
    checksumData[1] = 536584173;
    checksumData[2] = 234648427;
    checksumData[3] = 240124166;
...

  {
    ...
    checksumData[0] = 916655354;
    checksumData[1] = 3713435718;
    checksumData[2] = 1129251299;
    checksumData[3] = 1291339802;
...

  {
    ...
    checksumData[0] = 1326858323;
    checksumData[1] = 3351630546;
    checksumData[2] = 2951799500;
    checksumData[3] = 1804103348;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "2GpPLsa2NpR4LFOrvnLIcE") == 0) {
    extern mxArray *cgxe_2GpPLsa2NpR4LFOrvnLIcE_BuildInfoUpdate(void);
    plhs[0] = cgxe_2GpPLsa2NpR4LFOrvnLIcE_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "2GpPLsa2NpR4LFOrvnLIcE") == 0) {
    extern mxArray *cgxe_2GpPLsa2NpR4LFOrvnLIcE_fallback_info(void);
    plhs[0] = cgxe_2GpPLsa2NpR4LFOrvnLIcE_fallback_info();
    return 1;
  }
