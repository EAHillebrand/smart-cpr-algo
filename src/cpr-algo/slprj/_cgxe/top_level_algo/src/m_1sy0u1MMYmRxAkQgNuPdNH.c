...
#include "m_1sy0u1MMYmRxAkQgNuPdNH.h"
...
static void cgxe_mdl_start(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S, int_T tid)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S, int_T tid)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
  InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *moduleInstance =
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH *)calloc(1, sizeof
    (InstanceStruct_1sy0u1MMYmRxAkQgNuPdNH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_1sy0u1MMYmRxAkQgNuPdNH);
  ssSetmdlInitializeConditions(S, mdlInitialize_1sy0u1MMYmRxAkQgNuPdNH);
  ssSetmdlUpdate(S, mdlUpdate_1sy0u1MMYmRxAkQgNuPdNH);
  ssSetmdlTerminate(S, mdlTerminate_1sy0u1MMYmRxAkQgNuPdNH);
  ssSetmdlEnable(S, mdlEnable_1sy0u1MMYmRxAkQgNuPdNH);
  ssSetmdlDisable(S, mdlDisable_1sy0u1MMYmRxAkQgNuPdNH);
...
static void mdlProcessParameters_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S)
{
}

void method_dispatcher_1sy0u1MMYmRxAkQgNuPdNH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_1sy0u1MMYmRxAkQgNuPdNH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_1sy0u1MMYmRxAkQgNuPdNH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_1sy0u1MMYmRxAkQgNuPdNH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_1sy0u1MMYmRxAkQgNuPdNH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 1sy0u1MMYmRxAkQgNuPdNH.\n"
...
mxArray *cgxe_1sy0u1MMYmRxAkQgNuPdNH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_1sy0u1MMYmRxAkQgNuPdNH_fallback_info(void)
{
