...
#include "m_gMMMjlPA30Bjcn0FnG7YkD.h"
...
static void cgxe_mdl_start(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S, int_T tid)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S, int_T tid)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
  InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *moduleInstance =
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD *)calloc(1, sizeof
    (InstanceStruct_gMMMjlPA30Bjcn0FnG7YkD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_gMMMjlPA30Bjcn0FnG7YkD);
  ssSetmdlInitializeConditions(S, mdlInitialize_gMMMjlPA30Bjcn0FnG7YkD);
  ssSetmdlUpdate(S, mdlUpdate_gMMMjlPA30Bjcn0FnG7YkD);
  ssSetmdlTerminate(S, mdlTerminate_gMMMjlPA30Bjcn0FnG7YkD);
  ssSetmdlEnable(S, mdlEnable_gMMMjlPA30Bjcn0FnG7YkD);
  ssSetmdlDisable(S, mdlDisable_gMMMjlPA30Bjcn0FnG7YkD);
...
static void mdlProcessParameters_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S)
{
}

void method_dispatcher_gMMMjlPA30Bjcn0FnG7YkD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_gMMMjlPA30Bjcn0FnG7YkD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_gMMMjlPA30Bjcn0FnG7YkD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_gMMMjlPA30Bjcn0FnG7YkD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_gMMMjlPA30Bjcn0FnG7YkD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: gMMMjlPA30Bjcn0FnG7YkD.\n"
...
mxArray *cgxe_gMMMjlPA30Bjcn0FnG7YkD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_gMMMjlPA30Bjcn0FnG7YkD_fallback_info(void)
{
