...
#include "m_4AFu0YWUn0wmiH5SxFX14.h"
...
static void cgxe_mdl_start(InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
...
static void cgxe_mdl_set_sim_state(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_4AFu0YWUn0wmiH5SxFX14
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_4AFu0YWUn0wmiH5SxFX14(SimStruct *S, int_T tid)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_4AFu0YWUn0wmiH5SxFX14(SimStruct *S, int_T tid)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void setSimState_4AFu0YWUn0wmiH5SxFX14(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
  InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *moduleInstance =
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14 *)calloc(1, sizeof
    (InstanceStruct_4AFu0YWUn0wmiH5SxFX14));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_4AFu0YWUn0wmiH5SxFX14);
  ssSetmdlInitializeConditions(S, mdlInitialize_4AFu0YWUn0wmiH5SxFX14);
  ssSetmdlUpdate(S, mdlUpdate_4AFu0YWUn0wmiH5SxFX14);
  ssSetmdlTerminate(S, mdlTerminate_4AFu0YWUn0wmiH5SxFX14);
  ssSetmdlEnable(S, mdlEnable_4AFu0YWUn0wmiH5SxFX14);
  ssSetmdlDisable(S, mdlDisable_4AFu0YWUn0wmiH5SxFX14);
...
static void mdlProcessParameters_4AFu0YWUn0wmiH5SxFX14(SimStruct *S)
{
}

void method_dispatcher_4AFu0YWUn0wmiH5SxFX14(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_4AFu0YWUn0wmiH5SxFX14(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_4AFu0YWUn0wmiH5SxFX14(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_4AFu0YWUn0wmiH5SxFX14(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_4AFu0YWUn0wmiH5SxFX14(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 4AFu0YWUn0wmiH5SxFX14.\n"
...
mxArray *cgxe_4AFu0YWUn0wmiH5SxFX14_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_4AFu0YWUn0wmiH5SxFX14_fallback_info(void)
{
