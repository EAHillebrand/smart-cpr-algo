...
#include "m_tiw4bWAqD5YW2zyv4ESMwG.h"
...
static void cgxe_mdl_start(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S, int_T tid)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S, int_T tid)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
  InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *moduleInstance =
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG *)calloc(1, sizeof
    (InstanceStruct_tiw4bWAqD5YW2zyv4ESMwG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tiw4bWAqD5YW2zyv4ESMwG);
  ssSetmdlInitializeConditions(S, mdlInitialize_tiw4bWAqD5YW2zyv4ESMwG);
  ssSetmdlUpdate(S, mdlUpdate_tiw4bWAqD5YW2zyv4ESMwG);
  ssSetmdlTerminate(S, mdlTerminate_tiw4bWAqD5YW2zyv4ESMwG);
  ssSetmdlEnable(S, mdlEnable_tiw4bWAqD5YW2zyv4ESMwG);
  ssSetmdlDisable(S, mdlDisable_tiw4bWAqD5YW2zyv4ESMwG);
...
static void mdlProcessParameters_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S)
{
}

void method_dispatcher_tiw4bWAqD5YW2zyv4ESMwG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tiw4bWAqD5YW2zyv4ESMwG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tiw4bWAqD5YW2zyv4ESMwG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tiw4bWAqD5YW2zyv4ESMwG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tiw4bWAqD5YW2zyv4ESMwG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tiw4bWAqD5YW2zyv4ESMwG.\n"
...
mxArray *cgxe_tiw4bWAqD5YW2zyv4ESMwG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tiw4bWAqD5YW2zyv4ESMwG_fallback_info(void)
{
