...
static void cgxe_mdl_start(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S, int_T tid)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S, int_T tid)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
  InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *moduleInstance =
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE *)calloc(1, sizeof
    (InstanceStruct_2GpPLsa2NpR4LFOrvnLIcE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_2GpPLsa2NpR4LFOrvnLIcE);
  ssSetmdlInitializeConditions(S, mdlInitialize_2GpPLsa2NpR4LFOrvnLIcE);
  ssSetmdlUpdate(S, mdlUpdate_2GpPLsa2NpR4LFOrvnLIcE);
  ssSetmdlTerminate(S, mdlTerminate_2GpPLsa2NpR4LFOrvnLIcE);
  ssSetmdlEnable(S, mdlEnable_2GpPLsa2NpR4LFOrvnLIcE);
  ssSetmdlDisable(S, mdlDisable_2GpPLsa2NpR4LFOrvnLIcE);
...
static void mdlProcessParameters_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S)
{
}

void method_dispatcher_2GpPLsa2NpR4LFOrvnLIcE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_2GpPLsa2NpR4LFOrvnLIcE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_2GpPLsa2NpR4LFOrvnLIcE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_2GpPLsa2NpR4LFOrvnLIcE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_2GpPLsa2NpR4LFOrvnLIcE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 2GpPLsa2NpR4LFOrvnLIcE.\n"
...
mxArray *cgxe_2GpPLsa2NpR4LFOrvnLIcE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_2GpPLsa2NpR4LFOrvnLIcE_fallback_info(void)
{
