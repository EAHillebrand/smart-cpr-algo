...
#include "m_dxCR6TiNaP3voJJHbi3NYF.h"
...
static void cgxe_mdl_start(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLESend *obj);
static void mw__internal__call__reset(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_dxCR6TiNaP3voJJHbi3NYF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S, int_T tid)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S, int_T tid)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
  InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *moduleInstance =
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF *)calloc(1, sizeof
    (InstanceStruct_dxCR6TiNaP3voJJHbi3NYF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_dxCR6TiNaP3voJJHbi3NYF);
  ssSetmdlInitializeConditions(S, mdlInitialize_dxCR6TiNaP3voJJHbi3NYF);
  ssSetmdlUpdate(S, mdlUpdate_dxCR6TiNaP3voJJHbi3NYF);
  ssSetmdlTerminate(S, mdlTerminate_dxCR6TiNaP3voJJHbi3NYF);
  ssSetmdlEnable(S, mdlEnable_dxCR6TiNaP3voJJHbi3NYF);
  ssSetmdlDisable(S, mdlDisable_dxCR6TiNaP3voJJHbi3NYF);
...
static void mdlProcessParameters_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S)
{
}

void method_dispatcher_dxCR6TiNaP3voJJHbi3NYF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_dxCR6TiNaP3voJJHbi3NYF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_dxCR6TiNaP3voJJHbi3NYF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_dxCR6TiNaP3voJJHbi3NYF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_dxCR6TiNaP3voJJHbi3NYF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: dxCR6TiNaP3voJJHbi3NYF.\n"
...
mxArray *cgxe_dxCR6TiNaP3voJJHbi3NYF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_dxCR6TiNaP3voJJHbi3NYF_fallback_info(void)
{
